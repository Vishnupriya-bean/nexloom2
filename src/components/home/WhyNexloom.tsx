...
//     <RevealOnScroll>
//       <SectionLabel className="text-blue-400 uppercase tracking-wide text-sm font-semibold">
//         {c.aboutLabel}
//       </SectionLabel>
//     </RevealOnScroll>

//     {(c.aboutHeading || c.aboutHeadingGradient) && (
...
//       <p className="text-slate-400 text-base sm:text-lg leading-relaxed max-w-2xl italic">
//         {c.aboutText}
//       </p>
//     </RevealOnScroll>
  ...
  return (
    <>
      ...
      <SectionWrapper id="about" className="bg-[hsl(222,47%,11%)]">
        <div className="max-w-6xl mx-auto flex flex-col gap-6">
          <RevealOnScroll>
            <SectionLabel className="text-white   text-sm font-semibold">
              {c.aboutLabel}
            </SectionLabel>
          </RevealOnScroll>
